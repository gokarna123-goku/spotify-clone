...
const Info = () => {
    return (
        <div className='w-full h-auto flex items-center gap-x-7 md:pl-5 pl-4 md:pr-7 sm:pr-5 pr-4'>
            <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" alt="" className="w-52 aspect-square rounded-md object-cover object-center shadow-xl" />
            <div className="space-y-2">
                <p className="text-sm text-neutral-100">Playlist</p>
                <h1 className="text-8xl font-black text-neutral-50 tracking-tight !mb-4">Arijit Singh Radio</h1>
